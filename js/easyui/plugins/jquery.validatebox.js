...
$.fn.validatebox.defaults={required:false,validType:null,delay:200,missingMessage:"字段是必填项.",invalidMessage:null,tipPosition:"right",rules:{email:{validator:function(_26){
