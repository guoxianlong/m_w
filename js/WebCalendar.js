...
{
    var date = new Date();
    var by = date.getFullYear()-5;  //最小值 → 50 年前
    var ey = date.getFullYear()+1;  //最大值 → 50 年后
...
Calendar.prototype.draw = function() {
  ...
  mvAry[mvAry.length]  = '        <th colspan="2"><input disabled="true" name="calendarClear" type="button" id="calendarClear" value="' + Calendar.language["clear"][this.lang] + '" style="border: 1px solid ' + calendar.colors["input_border"] + ';background-color:' + calendar.colors["input_bg"] + ';width:100%;height:20px;font-size:12px;"/></th>';
