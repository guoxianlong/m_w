...
public class DateUtil {
	...
	/**
	 * 去掉'2015-05-09 00:00:00.0'尾部的'.0'
	 * @create yaoliang
	 * @time 2015-05-22
	 * @param date
	 * @return 格式化后的时间字符串
	...
	public static String formatDate(String date){
		Date date1 = DateUtil.parseDate(date,normalTimeFormat);
	...
	/**
	 * 提取单据号中的日期，只提取年月日
	 * <br/>只适用于以字母开头，后面紧跟yyyyMMdd格式的日期；例如：D2012010100001,J201201010001X,AV20120101xxx
	 * @param code 单据号
	 * @return 返回yyyy-MM-dd格式的日期字符串，如果解析异常返回null
	 * @author likaige
	 * @create 2015年7月24日 上午8:57:28
	 */
	public static String getDateByCode(String code){
		try {
			//过滤掉开头的字母
			...
			Date date = DateUtil.parseDate(dateStr, "yyyyMMdd");
