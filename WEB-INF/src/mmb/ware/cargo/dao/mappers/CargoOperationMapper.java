...
@Repository
public class CargoOperationMapper extends AbstractDaoSupport implements CargoOperationDao {
	...
	@Override
	public int insert(CargoOperation record) {
		getSession().insert(record);
		return record.getId();
	}

	@Override
	public CargoOperation selectByPrimaryKey(Integer id) {
		return getSession().selectOne(id);
	}
	@Override
	public CargoOperation selectByPrimaryKeySlave(Integer id) {
		return getSession(DynamicDataSource.SLAVE).selectOne(id);
	}

	@Override
	public CargoOperation selectByCondition(String condition) {
		return getSession().selectOne(condition);
	}
	
	@Override
	public CargoOperation selectByConditionSlave(String condition) {
	...
	@Override
	public List<CargoOperation> selectList(String condition, int index, int count, String orderBy) {
	...
	@Override
	public List<CargoOperation> selectListSlave(String condition, int index, int count, String orderBy) {
		HashMap<String, Object> map = new HashMap<String, Object>();
		map.put("condition", condition);
		map.put("index", index);
		map.put("count", count);
