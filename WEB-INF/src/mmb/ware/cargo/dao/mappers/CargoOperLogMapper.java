...
@Repository
public class CargoOperLogMapper extends AbstractDaoSupport implements CargoOperLogDao {
	@Override
	...
	@Override
	public int insert(CargoOperLog record) {
		getSession().insert(record);
		return record.getId();
	}

	@Override
	public CargoOperLog selectByPrimaryKey(Integer id) {
		return getSession().selectOne(id);
	}
	@Override
	public CargoOperLog selectByPrimaryKeySlave(Integer id) {
		return getSession(DynamicDataSource.SLAVE).selectOne(id);
	}

	@Override
	public CargoOperLog selectByCondition(String condition) {
		return getSession().selectOne(condition);
	}
	
	@Override
	public CargoOperLog selectByConditionSlave(String condition) {
	...
	@Override
	public List<CargoOperLog> selectList(String condition, int index, int count, String orderBy) {
	...
	@Override
	public List<CargoOperLog> selectListSlave(String condition, int index, int count, String orderBy) {
		HashMap<String, Object> map = new HashMap<String, Object>();
		map.put("condition", condition);
		map.put("index", index);
		map.put("count", count);
