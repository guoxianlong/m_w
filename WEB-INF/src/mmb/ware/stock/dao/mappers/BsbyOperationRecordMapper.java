...
@Repository
public class BsbyOperationRecordMapper extends AbstractDaoSupport implements BsbyOperationRecordDao {
	@Override
	...
	@Override
	public int insert(BsbyOperationRecord record) {
		getSession().insert(record);
		return record.getId();
	}

	@Override
	public BsbyOperationRecord selectByPrimaryKey(Integer id) {
		return getSession().selectOne(id);
	}
	@Override
	public BsbyOperationRecord selectByPrimaryKeySlave(Integer id) {
		return getSession(DynamicDataSource.SLAVE).selectOne(id);
	}

	@Override
	public BsbyOperationRecord selectByCondition(String condition) {
		return getSession().selectOne(condition);
	}
	
	@Override
	public BsbyOperationRecord selectByConditionSlave(String condition) {
	...
	@Override
	public List<BsbyOperationRecord> selectList(String condition, int index, int count, String orderBy) {
	...
	@Override
	public List<BsbyOperationRecord> selectListSlave(String condition, int index, int count, String orderBy) {
		HashMap<String, Object> map = new HashMap<String, Object>();
		map.put("condition", condition);
		map.put("index", index);
		map.put("count", count);
