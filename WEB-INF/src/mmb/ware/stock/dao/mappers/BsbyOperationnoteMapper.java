...
@Repository
public class BsbyOperationnoteMapper extends AbstractDaoSupport implements BsbyOperationnoteDao {
	@Override
	...
	@Override
	public int insert(BsbyOperationnote record) {
		getSession().insert(record);
		return record.getId();
	}

	@Override
	public BsbyOperationnote selectByPrimaryKey(Integer id) {
		return getSession().selectOne(id);
	}
	@Override
	public BsbyOperationnote selectByPrimaryKeySlave(Integer id) {
		return getSession(DynamicDataSource.SLAVE).selectOne(id);
	}

	@Override
	public BsbyOperationnote selectByCondition(String condition) {
		return getSession().selectOne(condition);
	}
	
	@Override
	public BsbyOperationnote selectByConditionSlave(String condition) {
	...
	@Override
	public int selectMaxCount(String condition) {
		return ((Integer) getSession().selectOne(condition)).intValue();
	}
	@Override
	...
	@Override
	public List<BsbyOperationnote> selectList(String condition, int index, int count, String orderBy) {
	...
	@Override
	public List<BsbyOperationnote> selectListSlave(String condition, int index, int count, String orderBy) {
		HashMap<String, Object> map = new HashMap<String, Object>();
		map.put("condition", condition);
		map.put("index", index);
		map.put("count", count);
