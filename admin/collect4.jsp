...
<p align="center">全库可发货订单商品汇总 <input type="button" onclick="javascript:exportList();" value="导出列表"/></p>
...
<tr>
  ...
  <td><%= op.getStock(ProductStockBean.AREA_BJ, 0) %></td>
  <td><%= op.getStock(ProductStockBean.AREA_GF, 0) %></td>
  <td><%
int oCount = 0;
