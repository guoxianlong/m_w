...
**************************/
        var strHtml1="<br><font color='#FF00FF'>打印控件未安装!点击这里<a href='/adult-admin/admin/barcodeManager/install_lodop.exe'>执行安装</a>,安装后请刷新页面或重新进入。</font>";
        var strHtml2="<br><font color='#FF00FF'>打印控件需要升级!点击这里<a href='/adult-admin/admin/barcodeManager/install_lodop.exe'>执行升级</a>,升级后请重新进入。</font>";
	...
	try{		     
		 ...
		 LODOP.SET_LICENSES("买卖宝信息技术有限公司","155547680718189907689190562356","","");	
	     //*******************************************
	     return LODOP; 
	}catch(err){
