...
<script language="JavaScript" src="<%=request.getContextPath()%>/admin/js/count2.js"></script>
   ...
   function checkFileType(theform){ 
		...
		if(theform.content.value==""||theform.content.value=="请填写财务审核意见"){
			alert("请填写财务审核意见!");
			return (false);    
		}
	...
	<form name="uploadfile" method="post" action="<%=request.getContextPath()%>/admin/bsbyUpload.do" enctype="multipart/form-data" onsubmit="return checkFileType(this)">
	<table>
	<tr>
	
	<td><input id="file" name="file" type="file" ></td>
	<td><input id="content" name="content" value="请填写财务审核意见" onclick="this.value=''"></td>
	<td><input type="submit" name="Submit" value="审核提交" id="submitId"></td>
	</tr>
	</table>
	</form>
