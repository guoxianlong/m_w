...
<table id="__01"  border="1" cellpadding="0" cellspacing="0" style="font-family: SimHei;">
	...
	<tr>
		<td colspan="5" style="width: 100mm;height: 18mm;" align="left" >
			<img src="<%=request.getContextPath()%>/image/logo_fhd.bmp" width="110px" height="50px"/>&nbsp;<font size='3'><%if(voOrder.deliverInfoMapAll.get(order.getDeliver()).getIsems()==1){ %>EMS<%} %></font></td>
	</tr>
	<tr>
	...
	<tr>
		<td colspan="5" style="width: 100mm;height: 17mm;" align="left" >
			...
			<img src="<%=request.getContextPath()%>/image/logo_fhd.bmp" width="110px" height="50px"/>&nbsp;<font size='3'><%if(voOrder.deliverInfoMapAll.get(order.getDeliver()).getIsems()==1){ %>EMS<%} %></font>
			<%} %>
		</td>
	</tr>
