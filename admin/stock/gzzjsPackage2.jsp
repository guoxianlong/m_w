...
<table id="__01"  border="1" cellpadding="0" cellspacing="0" style="font-family: SimHei;">
	...
	<tr>
		<td colspan="5"><strong>配送员存联</strong>&nbsp;&nbsp;&nbsp;&nbsp;快递公司：<%=order.getDeliverName() %></td>
	</tr>
	<tr>
...
function initPrint(){
	...
	if(LODOP.PRINT_INIT("")){ //mmb发货清单打印
		...
		LODOP.ADD_PRINT_TABLE("0","-3mm","99mm","140mm",cssStyle+document.getElementById("gzzjsPackage").innerHTML);
		LODOP.ADD_PRINT_BARCODE("26mm", "52mm","12mm", "10mm", "128A", "<%=orderCode.toUpperCase()%>");
		LODOP.ADD_PRINT_BARCODE("81mm", "8mm","12mm", "10mm", "128A", "<%=order.getCode()%>");
