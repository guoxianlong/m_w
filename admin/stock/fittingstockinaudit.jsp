	...
	function confirm(value){
		if(value==1){
			$.ajax({
				   ...
				   data: "code="+$('#code').html()+"&remark="+$("#remark").val()+"&operation=audit",
				   success: function(msg){
					   window.location.href = "${pageContext.request.contextPath}/admin/stock/fittingstockin.jsp";
				   }
				});
		}
		if(value==0){			
			$.ajax({
				   type: "POST",
				   url: '${pageContext.request.contextPath}/fittingController/updateStockinListconfirm.mmx',
				   data: "code="+$('#code').html()+"&remark="+$("#remark").val()+"&operation=UNaudit",
				   success: function(msg){
					   window.location.href = "${pageContext.request.contextPath}/admin/stock/fittingstockin.jsp";
				   }
				});
