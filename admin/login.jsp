...
if (window!=top){ // 判断当前的window对象是否是top对象
	...
	if(parentLocation!=null){
		...
		var url = parentLocation.protocol+"//"+parentLocation.host+"/adult-admin/login.do";
...
<table border="0" cellpadding="0" cellspacing="0" id="dv">
  <tr>
    <td style="background:white url(images/blue_03.gif) no-repeat top left">
  ...
  <tr>
    <td><div style="margin:5px 5px 5px 15px"><img src="images/line.gif" /></div></td>
  </tr>
  <tr>
