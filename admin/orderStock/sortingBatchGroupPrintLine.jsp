							...
							%>
									...
									<%if((i>=productList.size()&&oldOrderProduct==null) || index>=MAXLINE) { %>
										<tr bordercolor="#000000">
											...
											<%if(!"S".equals(order.getCode().substring(0,1))&&!"".equals(order.getUserOrderCommentCode())&&!order.isTaobaoOrder()&&!order.isJdAdultOrder()){ 
											%>
												评价订单赢Q币：1)加官方微信maimaibaomall;或2)访问pj.mmb.cn均可评价；评价码：<%=order.getUserOrderCommentCode() %>
											<%} %>
											</td>
										</tr>
										<tr>
												...
												<table width="730px" cellpadding="1" style="border: none; border-collapse: collapse;">
													<tr>
														...
														<%if(!order.isJdAdultOrder()){ %>
															<div align="center">
																<img src="<%=request.getContextPath()%>/image/logo_fhd.png" width="100px" height="40px" align="middle" />
															</div>
														<%} %>
														</td>
														<td width="248" rowspan="4" align="center" valign="baseline">
															<p align="left">
																<%if(!order.isJdAdultOrder()){ %>
																<strong>购物方便，货到付款</strong><br>
																<strong>优质廉价，自由退换</strong>
																<%} %>
															</p>
														</td>
														...
														<td width="90" rowspan="4" valign="top">
															...
															<img src="<%=request.getContextPath()%>/image/maimaibaomall4.bmp" width="85px" height="85px" align="middle" />
														</td>
														<td colspan="4">
															<div align="left">客服热线:400-884-3211</div>
														</td>
														<%} %>
					                				</tr>
					                				<%if(!order.isTaobaoOrder()&&!order.isJdAdultOrder()){ %>
									          		<tr bordercolor="#000000">
									          			<td colspan="4">
									          				<div align="left">售后邮箱：mmbsh@mmb.cn</div>
									          			</td>
													</tr>
									          		<tr bordercolor="#000000">
									          			<td height="20" colspan="4">
									          				<div align="left">退换货事宜：详见买卖宝网页</div>
									          			</td>
													</tr>
									          		<tr bordercolor="#000000">
									          			<td height="20" colspan="2"><div  class="divcss5" align="left">温馨提醒：退换货时请将此购物清单随商品一起寄回</div></td>
									          			<td width="203" colspan="4"><div align="left">手机访问：mmb.cn</div></td>
													</tr>
													<%}else{ %>
													<tr bordercolor="#000000">
									          			<td colspan="4">
