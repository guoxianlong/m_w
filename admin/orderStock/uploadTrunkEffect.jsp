...
<html>
  ...
  <body>
  	<h3 align="center">添加干线时效</h3>
  	<table border="1" width=500px>
  		<tr><td>
			<form action="${pageContext.request.contextPath}/TrunkLineController/uploadTrunkEffect.mmx" method="post" enctype="multipart/form-data" onsubmit="return checkUpload();"> 
  		...
  		<tr><td>  		
  			操作信息:
  			<div style="float: right;  position: relative; "><a href="${pageContext.request.contextPath}/TrunkLineController/downloadTrunkEffect.mmx">下载模板</a></div>
  		</td>
  		</tr>
  		<tr><td>
  			<% if(result != null){ %>
