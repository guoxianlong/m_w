...
$(function(){
	...
	datagrid = $('#datagrid').datagrid({
		url : '${pageContext.request.contextPath}/EffectController/getCommonTypeList.mmx?type=1',
		queryParams: {
	    ...
	    columns:[[  
	        ...
	        {field:'fhCount',title:'发货量',width:20,align:'center'},  
	        {field:'ttper',title:'妥投率',width:30,align:'center'}, 
	        {field:'thper',title:'退回率',width:20,align:'center'}, 
	        {field:'zxper',title:'正向在途率',width:20,align:'center'}, 
	        {field:'nxper',title:'逆向在途率',width:25,align:'center'}
	    ]]
	}); 
});
function searchFun() {
...
<div id="toolbar" class="datagrid-toolbar" style="height: auto;">
			<form id="searchForm" action="${pageContext.request.contextPath}/EffectController/portExcel.mmx?type=1" method="post">
			<table>
				<tr>
					<td>
