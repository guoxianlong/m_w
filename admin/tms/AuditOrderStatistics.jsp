...
function loadHighstock(names){
	...
	$.each(names, function(i, name) {
		...
		$.getJSON('${pageContext.request.contextPath}/deliverController/getHighstockData.mmx?parameter=audit_' + name + "&startDate=" + startDate + "&endDate=" + endDate,	function(data) {
			seriesOptions[i] = {
				name: name,
				data: data
			};
