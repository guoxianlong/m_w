...
<html>
<head>
<title>快递公司当日投递及时率统计</title>

<jsp:include page="../rec/inc/easyui.jsp"></jsp:include>s
...
function loadHighstock(names){
	...
	$.each(names, function(i, name) {
		...
		$.getJSON('${pageContext.request.contextPath}/deliverController/getHighstockData.mmx?parameter=mailing_' + name + "&startDate=" + startDate + "&endDate=" + endDate,	function(data) {
			seriesOptions[i] = {
				name: name,
				data: data
			};
