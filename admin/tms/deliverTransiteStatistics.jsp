...
function loadHighstock(names){
	...
	$.each(names, function(i, name) {
		...
		$.getJSON('${pageContext.request.contextPath}/deliverController/getHighstockData.mmx?parameter=transite_' + name + "&startDate=" + startDate + "&endDate=" + endDate,	function(data) {
			seriesOptions[i] = {
				name: name,
				data: data
			};
