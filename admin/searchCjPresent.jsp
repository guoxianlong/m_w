...
<p>
<pre>
<b><font size=5>成交订单赠品查询</font></b>
  规则说明:
1、某一时间段内生成且已成交的订单中各赠品成交量的查询统计
2、时间:按订单生成日期计算
...
<form name="sForm" method=post action="searchCjPresent.do">
<%
...
产品线:
 	...
 	%>
 	 ...
 	 <br/>
<input type=submit value="查询赠品成交量">
</form>
</td></tr>
</table>
</td></tr></table>
