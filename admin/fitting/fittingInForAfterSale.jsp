...
$(function(){
	datagrid = $('#datagrid').datagrid({
	    url:'${pageContext.request.contextPath}/fittingStockCardController/getInStockCardListForAfterSale.mmx',
	    toolbar : '#tb',
	    idField : 'id',
	    fit : true,
	    fitColumns : true,
	    ...
	    columns:[[ 
					{field:'datetime',title:'入库时间',width: 10 ,align:'center',
			        	formatter: function(value, row, index){
			        		return value.substring(0,10);
			        	}},
					{field:'fittingName',title:'配件名称',width: 20 ,align:'center'},
					{field:'fittingTypeName',title:'配件类别',width: 20 ,align:'center'},
					{field:'billType',title:'相关单据类型',width: 20 ,align:'center'},					
					{field:'billCode',title:'相关单据编号',width: 20 ,align:'center'}, 
					{field:'username',title:'入库人',width: 10 ,align:'center'},
					{field:'inOutType',title:'入库类型',width: 10 ,align:'center'},
...
function searchFun() {
	...
	datagrid.datagrid('load', {
		...
		startDate : startDate,
		endDate : endDate,
		stockInType : $("#stockInType").combobox("getValue")
	 });
}
</script>
		...
		<fieldset>
			...
			<table class="" >
				...
				<tr align="center" >
					...
					<th >入库类型</th>
					<td align="left">
						<input id="stockInType" name="stockInType" style="width: 116px "/></td>					
					<td align="right" >
