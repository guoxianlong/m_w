...
<html>
<head>
<title>售后配件货位列表</title>
<jsp:include page="../rec/inc/easyui.jsp"></jsp:include>
<script type="text/javascript" charset="UTF-8">
var datagrid;
$(function(){
	datagrid = $('#datagrid').datagrid({
	    url:'${pageContext.request.contextPath}/fittingController/getFittingDatagrid.mmx?stockType=11',
	    toolbar : '#tb',
	    idField : 'fittingId',
	    fit : true,
	    fitColumns : true,
	    ...
	    columns : [[	    	
	    	...
	    	{field:"fittingTypeName",title:'配件类别',align:'center',width:120},
    ...
    $('#fittingType').combobox({
      	url : '${pageContext.request.contextPath}/Combobox/getFittingBuyStockInProductType.mmx?flag=query',
      	valueField:'id',
		textField:'text',
		editable:false
    });
...
function searchFun() {
	datagrid.datagrid('load', {
		...
		fittingType : $('#fittingType').combobox('getValue')
	});
}
</script>
</head>
		...
		<fieldset>
			...
			<table class="" >
				<tr align="center">
					...
					<th align="right">配件类别：</th>
					<td><input type="text" id="fittingType" name="fittingType" style="width: 116px" /></td>
				</tr>
				<tr align="center" >
