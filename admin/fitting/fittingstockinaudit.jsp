...
<script type="text/javascript" charset="UTF-8">
	...
	function confirm(value){
		if(value==1){
			 window.location.href = "${pageContext.request.contextPath}/fittingBuyStockinController/auditFittingBuyStockin.mmx?code="+$('#code').html()+"&remark="+$("#remark").val()+"&mark=1";
		}
		if(value==0){			
			 window.location.href = "${pageContext.request.contextPath}/fittingBuyStockinController/auditFittingBuyStockin.mmx?code="+$('#code').html()+"&remark="+$("#remark").val()+"&mark=0";
		}
	}
