...
<%
		...
		String sql = "select t1.da,t11.c,t11.p,t12.c,t12.p,t13.c,t13.p,t21.c,t21.p,t22.c,t22.p,t23.c,t23.p,t31.c,t31.p,t32.c,t32.p,t33.c,t33.p,t41.c,t41.p,t42.c,t42.p,t43.c,t43.p,t51.c,t51.p,t52.c,t52.p,t53.c,t53.p,t61.c,t61.p,t62.c,t62.p,t63.c,t63.p,t71.c,t71.p,t72.c,t72.p,t73.c,t73.p from " +
			...
			"left outer join " +    
			"(select left(create_datetime,10) da,count(*) c,sum(dprice) p from user_order where buy_mode=1 group by da) t11 " +
			"on t1.da=t11.da " +
			"left outer join " +
			"(select left(create_datetime,10) da,count(*) c,sum(dprice) p from user_order where buy_mode=0 group by da) t12 " +
			"on t1.da=t12.da " +
			"left outer join " +
			"(select left(create_datetime,10) da,count(*) c,sum(dprice) p from user_order where buy_mode=2 group by da) t13 " +
			"on t1.da=t13.da " +
			"left outer join " +
			"(select left(create_datetime,10) da,count(*) c,sum(dprice) p from user_order where buy_mode=1 and status in (3,6,9,12,14) group by da) t21 " +
			"on t1.da=t21.da " +
			"left outer join " +
			"(select left(create_datetime,10) da,count(*) c,sum(dprice) p from user_order where buy_mode=0 and status in (3,6,9,12,14) group by da) t22 " +
			"on t1.da=t22.da " +
			"left outer join " +
			"(select left(create_datetime,10) da,count(*) c,sum(dprice) p from user_order where buy_mode=2 and status in (3,6,9,12,14) group by da) t23 " +
			"on t1.da=t23.da " +
			"left outer join " +
			...
			"on t1.da=t43.da " +
			"left outer join " +
			"(select left(create_datetime,10) da,count(*) c,sum(dprice) p from user_order where buy_mode=1 and status in (6,11,12) group by da) t51 " +
			"on t1.da=t51.da " +
			"left outer join " +
			"(select left(create_datetime,10) da,count(*) c,sum(dprice) p from user_order where buy_mode=0 and status in (6,11,12) group by da) t52 " +
			"on t1.da=t52.da " +
			"left outer join " +
			"(select left(create_datetime,10) da,count(*) c,sum(dprice) p from user_order where buy_mode=2 and status in (6,11,12) group by da) t53 " +
			"on t1.da=t53.da " +
			"left outer join " +
			"(select left(create_datetime,10) da,count(*) c,sum(dprice) p from user_order where buy_mode=1 and status in (11,13) group by da) t61 " +
			"on t1.da=t61.da " +
			"left outer join " +
			"(select left(create_datetime,10) da,count(*) c,sum(dprice) p from user_order where buy_mode=0 and status in (11,13) group by da) t62 " +
			"on t1.da=t62.da " +
			"left outer join " +
			"(select left(create_datetime,10) da,count(*) c,sum(dprice) p from user_order where buy_mode=2 and status in (11,13) group by da) t63 " +
			"on t1.da=t63.da " +
			"left outer join " +
			"(select left(create_datetime,10) da,count(*) c,sum(dprice) p from user_order where buy_mode=1 and status = 14 group by da) t71 " +
			"on t1.da=t71.da " +
			"left outer join " +
			"(select left(create_datetime,10) da,count(*) c,sum(dprice) p from user_order where buy_mode=0 and status = 14 group by da) t72 " +
			"on t1.da=t72.da " +
			"left outer join " +
			"(select left(create_datetime,10) da,count(*) c,sum(dprice) p from user_order where buy_mode=2 and status = 14 group by da) t73 " +
			"on t1.da=t73.da " +
