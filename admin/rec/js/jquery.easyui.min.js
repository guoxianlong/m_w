...
},beforePageText:"第",afterPageText:"页 {pages}",displayMsg:"当前显示{from}-{to}条记录   共 {total}记录",nav:{first:{iconCls:"pagination-first",handler:function(){
...
$.fn.validatebox.defaults={required:false,validType:null,delay:200,missingMessage:"这是必填项.",invalidMessage:null,tipPosition:"right",deltaX:0,tipOptions:{showEvent:"none",hideEvent:"none",showDelay:0,hideDelay:0,zIndex:"",onShow:function(){
...
},message:"请输入email地址."},url:{validator:function(_3e9){
...
},message:"请输入 {0} 到 {1}字符。"},remote:{validator:function(_3ec,_3ed){
var data={};
data[_3ed[1]]=_3ec;
