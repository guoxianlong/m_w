...
$(function () {
	setDate();
	$('#area').combobox({
      	url : '${pageContext.request.contextPath}/SortingStatController/getDeptAreaComboBox.mmx',
      	valueField:'id',
		textField:'text' 
    });
...
function loadHicharts(){
	...
	$.ajax({
		url : '${pageContext.request.contextPath}/SortingStatController/sortingStat.mmx',
		type : 'post',
		dataType : 'json',
		cache : 'false',
		data : {
