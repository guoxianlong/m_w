...
<div id="tb" style="padding:3px;height: auto;">
	<fieldset>
		<legend>个人分播量统计</legend>
		<span style="font-size: 12px;">分播人：</span>
		<input type="text" name="userName" value="<%=userName %>" id="userName" maxlength="45"/>
		<span style="font-size: 12px;">分播日期：</span>
		<input name="dateStart" id="dateStart" value="<%=dateStart %>" type="text" class="easyui-datebox" editable="false">
		<span style="font-size: 12px;">至</span><input name="dateEnd" id="dateEnd" type="text" value="<%=dateEnd %>" class="easyui-datebox" editable="false">
...
<table id="groupStatList" title="个人分播量统计列表" class="easyui-datagrid" style="width:'auto';height:'auto'"
        singleSelect="true" showFooter="false" fitColumns="true" iconCls="icon-ok">
</table>
</body>
<script type="text/javascript">
	$(function(){
		...
		$("#query").click(function(){
			...
			$.ajax({
				url:'<%=request.getContextPath()%>/sortingGroupStatController/sortingGroupStatByName.mmx',
				cache:false,
				dataType:'text',
				type:'post',
				data:{
