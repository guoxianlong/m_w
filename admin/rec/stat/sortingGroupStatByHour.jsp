...
<table id="groupStatList" title="每时分播量统计列表" class="easyui-datagrid" style="width:'auto';height:'auto'"
...
<script type="text/javascript">
	$(function(){
		...
		$.ajax({
			url:'<%=request.getContextPath()%>/sortingGroupStatController/sortingGroupStatByHour.mmx',
			cache:false,
			dataType:'text',
			type:'post',
