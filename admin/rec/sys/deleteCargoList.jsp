...
<body>
	<div style="width: 80%;">
		<fieldset>
			...
			<table>
				<tr>
					<td><span style="font-size: 12px;">货&nbsp;位&nbsp;号：</span><input type="text" size=20 name="wholeCode" id="wholeCode"/><span style="font-size: 12px;">左精确右模糊</span></td>
					<td><span style="font-size: 12px;">仓库号：</span><input name="storageId" style="width:120px;" class="easyui-combobox" editable="false" id="storageId"></td>
					<td><span style="font-size: 12px;">仓库区域：</span><input name="stockAreaId" style="width:120px;" class="easyui-combobox" editable="false" id="stockAreaId"></td>
					<td><span style="font-size: 12px;">巷&nbsp;&nbsp;&nbsp;&nbsp;道：</span><input name="passageId" style="width:120px;" class="easyui-combobox" editable="false" id="passageId"></td>
				</tr>
				<tr>
					<td><span style="font-size: 12px;">货架代号：</span><input name="shelfCode" id="shelfCode"><span style="font-size: 12px;">（如：01）</span></td>
					<td><span style="font-size: 12px;">第几层：</span><input type="text" size=5 name="floorNum" style="width:120px;" id="floorNum"/></td>
					<td><span style="font-size: 12px;">库存类型：</span><input name="stockType" style="width:120px;" class="easyui-combobox" editable="false" id="stockType"></td>
					<td><span style="font-size: 12px;">存放类型：</span><input name="storeType" style="width:120px;" class="easyui-combobox" editable="false" id="storeType"></td>
				</tr>
				<tr>
					<td><span style="font-size: 12px;">货位产品线：</span><input name="productLineId" style="width:120px;" class="easyui-combobox" editable="false" id="productLineId"></td>
					<td><span style="font-size: 12px;">货位类型：</span><input name="type" style="width:120px;" class="easyui-combobox" editable="false" id="type"></td>
					<td><a href="#" class="easyui-linkbutton" iconCls="icon-search" plain="true" id="queryShelf">查询</a><input type="hidden" id="page_hidden" value=""/></td>
				</tr>
			</table>
		</fieldset>
		<div style="padding: 5px;">
		<a id="deleteOpencargo" class="easyui-linkbutton" iconCls="icon-remove" plain="true">批量删除货位</a>
		</div>
...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#deleteOpencargo").click(function(){
			...
			if(items.length!=0){
				...
				$.messager.confirm('询问','如果确认删除，请单击确定，反之，请单击取消！',function(boo){
					if(boo){
						//选择true
						$.ajax({
							url:'<%=request.getContextPath()%>/CargoController/deleteCargo.mmx',
