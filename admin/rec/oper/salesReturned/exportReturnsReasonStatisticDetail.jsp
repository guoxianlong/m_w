  ...
  <table  width="99%" border="1" cellspacing="0" bordercolor="#00000">
	<tr bgcolor="#00ccff">
  	...
  	<tr>
  		...
  		<td align="center"><font color="#000000"><%= rpBean.getPackageCode() %></font></td>
  		<td align="center"><font color="#000000"><%= rpBean.getDeliverName() %></font></td>
  		<td align="center"><font color="#000000"><% if (rpBean.getStorageTime()!=null)%><%= rpBean.getStorageTime().substring(0,19) %><%else %><%="" %></font></td>
  		...
  		<td align="center"><font color="#000000"><%= rpBean.getReasonName() %></font></td>
  	</tr>
  			<% }
  		}		
  	 %>
