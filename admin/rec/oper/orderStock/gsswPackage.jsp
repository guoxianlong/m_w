...
<table id="__01"  border="1" cellpadding="0" cellspacing="0" style="font-family: SimHei; table-layout:fixed;word-break:break-all;">
	...
	<tr>
		...
		<%if(order.getDeliver()==37){ %>
			地址：<font style="font-weight: bold;">买卖宝<%=ProductStockBean.areaMap.get(osBean.getStockArea()) %>仓</font><br>
			
			发货人:无锡买卖宝&nbsp;&nbsp;&nbsp;&nbsp;电话：40088-43211
			<%}else{ %>
			寄件人：赵艳	<font style="margin-left:30px">电话：40088-43211</font><br>
			寄件地址：广州市站南路4号
			<%} %>
		</td>
	</tr>
