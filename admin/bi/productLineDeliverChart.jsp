...
$(function(){
	...
	$('#productLine').combobox({
		url : '${pageContext.request.contextPath}/Combobox/getProductLine.mmx',
		valueField : 'id',
		textField : 'text',
		editable : false,
		panelHeight : 'auto'
...
function checkSubmit() {
	...
	var productLine = $("#productCountForm input[id=productLine]").combobox('getValue'); 
...
function loadProductDatas(type) {
	...
	var endTime=$("#productCountForm input[id=endTime]").datebox("getValue");
	$.ajax({
		url : '${pageContext.request.contextPath}/BIController/getProductLineDeliverChart.mmx',
		type : 'post',
		data : {
			stockArea:stockArea,
			startYear : startYear,
			...
			<form id="productCountForm" method="post">
				<table class="tableForm">
					<tr align="center" >
						...
						<th>产品线：</th>
						<td align="left">
							<input id="productLine" name="productLine" style="width: 116px;"/>
						</td>
						<th>年：</th>
