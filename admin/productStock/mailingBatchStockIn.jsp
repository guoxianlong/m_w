...
function focusmailingBatchCode(){
	...
	if(mailingBatchCode.value=="输入发货波次编号..."){
	...
	<tr>
		...
		<td style="padding-top: 4mm">
			<form action="" onSubmit="return submitmailingBatchCode();">
				<input id="mailingBatchCode" type="text" value="输入发货波次编号..." onFocus="focusmailingBatchCode();" onBlur="blurmailingBatchCode();"/>
			</form>
		</td>
	</tr>
	<tr>
		...
		<td style="padding-top: 4mm">
			<form action="" onSubmit="return submitparcelCode();">
				<input id="parcelCode" type="text" value="输入发货邮包编号..." onFocus="focusparcelCode();" onBlur="blurparcelCode();"/>
			</form>		
		</td>
	</tr>
	<tr>
		<td style="padding-top: 5mm">
			<form name="addPackage" action="<%=request.getContextPath()%>/admin/mailingBatch.do?method=mailingBatchStockIn" method="post">
