...
<body >
<form action="<%=request.getContextPath()%>/admin/returnStorageAction.do?method=returnsReasonEdit&id=<%= id %>" method="post">
...
<table  width="35%" border="1" cellspacing="0" >
  ...
  <tr >
  	<td><div align="center"><input type="text" value="<%= code %>" name="code" id="code"></div></td>
    <td><div align="center"><input type="text" value="<%= reason %>" name="reason" id="reason"></div></td>
    <td><div align="center"><input type="button" value="修改" onclick="check()"></div></td>
  </tr>
 </table>
</form>
</body>
