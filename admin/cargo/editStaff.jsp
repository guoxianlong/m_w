...
<table cellpadding="3" border=1 style="border-collapse: collapse;"
	...
	<tr>
		<td>
		<span style="font-family: 微软雅黑; font-size: 16px; font-weight: bold; font-style: normal; text-decoration: none; color: #0000FF;">编辑员工资料</span>
		...
		<form name="editFrm" action="qualifiedStock.do?method=editStaff&save=1" method="post" onsubmit="return check(this)">
		...
		<table cellpadding="3">
			<tr>
				...
				<input name="nameStr" type="text" value="<%=csb.getName()%>"/> 
				<font color="red">*</font> 必填</td>
			</tr>
			<tr>
				<td>电&nbsp;&nbsp;&nbsp;&nbsp;话：</td>
				<td><input name="phone" type="text" value="<%=csb.getPhone() %>"/></td>
			</tr>
			<tr>
				<td>后台账户：</td>
				<td><input name="userName" type="text" value="<%=csb.getUserName()%>"/><font color="red">*</font> 必填
			...
			<tr>
				<td>&nbsp;</td>
				<td id="dept1">
					<SELECT name="deptCode1" id="deptCode1">
			...
			<tr>
				...
				<td><input type="button" value="取消" id="cancel" onclick="window.history.back(-1);"/></td>
			</tr>
		</table>
		</form>
		</td>
...
<script type="text/javascript">
selectOption(document.getElementById('deptCode0'), '<%=deptCode0%>');
selectdept0();
</script>
</body>
</html>