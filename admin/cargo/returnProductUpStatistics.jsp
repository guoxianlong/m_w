...
function searchFun(){
	...
	jQuery.post('<%=request.getContextPath()%>/admin/returnPackage.do?method=returnProductUpStatistics&time='+time 
...
<body>
退货上架统计单：地区：<input id="areaId" name="areaId" style="width:150px" value=""/><br>
<fieldset style="border:#06c dashed 1px; width: 70%">
	...
	<div id="resultInfo" style="display:none;width:71%; float:left; margin-left:15px;height:50px; border-style:solid;border-width:1pt;"></div>
</body>
</html>
