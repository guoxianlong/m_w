...
function check(){
	...
	if(cartonningCode == ""|| cartonningCode == "扫描装箱单编号"){
		...
		setTimeout("window.location='<%=request.getContextPath()%>/admin/cargo/soDownProduct.jsp';",5000);
	}
}
function checkEnter(){
...
<form action="<%=request.getContextPath()%>/admin/stockOperation.do?method=downProduct" method="post">
<table width="220" height="220" border="0" cellspacing="0">
<tr align="center">
	<td colspan="2"><font size="4" style="font-weight:bold">下架作业</font>
