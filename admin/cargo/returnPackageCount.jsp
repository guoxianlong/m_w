...
<form name="countResult" action="returnPackage.do?method=getCountResult&path=returnpackage" method="POST" onsubmit="return check();">
入库统计：地区：<select name="areaId" id="areaId">
...
<table width="100%" border="1">
	...
	<tr>
		<td>入库量时间：<input type="text" size="15" name="startTime" id="startTime" value="<%= time %>" onclick="WdatePicker();" />&nbsp;&nbsp;&nbsp;&nbsp;入库操作人：<input type="text" value="<%= operationid %>" name="operationid"/></td>
	</tr>
	<tr>
		<td>产品编号：<input type="text" name="productCode" value="<%= productCode %>"/>&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" value="查询"/></td>
	</tr>
</table>
</form>
<% if(flag){ %>
