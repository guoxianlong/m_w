...
<% 
 ...
 %>
	...
	<table width="240" height="135"   border="2" cellpadding="0" cellspacing="0" id="__01" style="font-family: SimHei;">
		<tr>
...
function initPrint(){
	...
	if(LODOP.PRINT_INIT("")){ //mmb发货清单打印
		...
		for(var i=0;i<temp;i++){
			LODOP.ADD_PRINT_TABLE("0mm","-1.5mm","35mm","70mm",cssStyle+document.getElementById("szzjPackage"+i).innerHTML);
			LODOP.ADD_PRINT_BARCODE("10.5mm", "20.5mm","36mm", "8mm", "code93", "<%=bean1.getProductBean().getProductCode()%>");
			LODOP.ADD_PRINT_BARCODE("1.5mm", "20.5mm","12mm", "9mm", "code93", list[i]);
