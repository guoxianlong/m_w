...
<STYLE type=text/css>
input,textarea,button,select { border:1px solid #8FAFCF;background-color:#FFFFFF }
P {FONT-SIZE: 9pt; FONT-FAMILY: 宋体}
TD {FONT-SIZE: 9pt; FONT-FAMILY: 宋体,simsun}
...
festival = '<TABLE WIDTH=100% BORDER=0 CELLPADDING=2 CELLSPACING=0 BGCOLOR="#CCCCCC"><TR><TD>'+
'<FONT COLOR="#000000" STYLE="font-size:9pt;">'+cld[d].solarTerms + ' ' + cld[d].solarFestival + ' ' + cld[d].lunarFestival+'</FONT></TD>'+
'</TR></TABLE>';

s= '<TABLE WIDTH="130" BORDER=0 CELLPADDING="2" CELLSPACING=0 BGCOLOR="#444455""><TR><TD>' +
...
<BODY leftMargin=0 topMargin=0 onload=initial() style="background:	#F8F8F8;margin-top:30px;">
...
<TABLE width="520">
  ...
  <TR>
    ...
    <TD vAlign=top align=middle><BR><FONT style="FONT-SIZE: 9pt" 
      ...
      size=2>本机时间:</FONT><FONT id=Clock face=Arial color=#000080 size=4 
      ...
      value="+1200 斐济、肯加塔、马歇尔群岛">斐济</OPTION></SELECT>时间 </FONT><FONT 

      id=Clock2 face=Arial color=#000080 size=4 align="center"></FONT><BR><FONT 

      id=CITY 

      style="FONT-SIZE: 9pt; WIDTH: 150px; COLOR: blue; FONT-FAMILY: '新细明体'"></FONT></P></TD></tr><tr>
    ...
    <TD align=middle><br/>
      ...
      <TABLE border=0>
        ...
        <TR>
          ...
          <TD bgColor=#707078 colSpan=7><FONT style="FONT-SIZE: 9pt" 
            ...
            </SELECT>月 </FONT><FONT id=GZ face=标楷体 color=#E0E030 
